...
-- Создание типа перечисления для ролей
DO $$ BEGIN
...
-- Создание таблицы profile.users, если она не существует
...
-- Создание таблицы device.firmware_timestamp, если она не существует
